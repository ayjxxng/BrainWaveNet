...
def get_args():
    ...
    parser.add_argument('--spectral_dmodel', type=int, default=16)
    parser.add_argument('--spectral_nheads', type=int, default=4)
    parser.add_argument('--spectral_dimff', type=int, default=32)

    parser.add_argument('--temporal_dmodel', type=int, default=64)
    parser.add_argument('--temporal_nheads', type=int, default=8)
    parser.add_argument('--temporal_dimff', type=int, default=128)
